...
| --detox    | Generate [Detox workflow](/setup-ci/docs/workflows/detox)                 |
| --maestro  | Generate [Maestro workflow](/setup-ci/docs/workflows/maestro)             |
| --eas      | Generate [EAS Preview workflow](/setup-ci/docs/workflows/eas)             |
